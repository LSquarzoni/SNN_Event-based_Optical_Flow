...
def replace_lif_layers_with_custom(model, resolution=None):
    """
    Replace SNNtorch LIF layers with custom LIF implementations for ONNX export.
...
def export_to_onnx(args, config_parser, export_quantized=False):    
    ...
    # Replace SNNtorch LIF layers with custom implementations for ONNX export
    print("\n" + "="*80)
    print("REPLACING LIF LAYERS WITH CUSTOM IMPLEMENTATIONS FOR ONNX EXPORT")
    print("="*80)
