...
from dataloader import PatchH5Loader, H5Loader
...
def train(args, config_parser):
    ...
    while True:
        for inputs in dataloader:
            ...
            if data.seq_num >= len(data.files):
                ...
                with torch.no_grad():
                    ...
                    if current_metric < best_metric - 1e-6:
                        ...
                        base_model_path = "/scratch2/msc25h1/models/LIF_FC_attempt2/"
            ...
            # forward pass
            x = model(inputs["event_cnt"].to(device))
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config",
        default="configs/train_SNN_FC.yml",
